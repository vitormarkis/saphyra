...
describe("infinite loop protection", () => {
  ...
  it("should throw when exceeding maxSyncDispatchCount", () => {
    let dispatchCount = 0
    const newStore = newStoreDef<
      InfiniteLoopState,
      InfiniteLoopState,
  ...
  it("should default to 1000 if maxSyncDispatchCount not specified", () => {
    let dispatchCount = 0
    const newStore = newStoreDef<
      InfiniteLoopState,
      InfiniteLoopState,
    ...
    expect(store.state.count).toBe(500)
  })
})
